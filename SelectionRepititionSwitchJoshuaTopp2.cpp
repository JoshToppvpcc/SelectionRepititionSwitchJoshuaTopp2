// SelectionRepititionSwitchJoshuaTopp2.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
int main()
{
	...
	case '/':
		if (secondDigit != 0) {
			...
			cout << "Please enter a valid denominator next time    ";
			main();
		}
	default : 
